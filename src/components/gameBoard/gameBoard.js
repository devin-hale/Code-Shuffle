...
const GameBoard = () => {
    ...
    const mapCards = cardState.map(card => {
        return (
            <div
                className=" text-[15px] md:text-[25px] bg-slate-300 shadow-lg rounded w-[100px] p-2 cursor-pointer text-center md:w-[150px] transition-all hover:scale-[102%] hover:transition-all"
                key={card.id}
                onClick={() => {
                    if (checkClickable(card)) {
                        ...
                        <div className="flex flex-col w-[300px] m-auto p-5 text-center text-lg">
                            ...
                            <ul className="list-disc">
                                <li className="w-fit text-[17px]">
                                    During each level, you may only click each
                                    language once.
                                </li>
                                <li className="w-fit text-[17px]">
                                ...
                                <li className="w-fit text-[17px]">
                                    If you click an icon twice in one level, you
                                    lose!
                                </li>
                            </ul>
                        </div>
